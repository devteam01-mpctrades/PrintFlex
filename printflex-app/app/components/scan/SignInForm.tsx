  ...
  return (
    <section className="card">
      ...
      <Form method="post" action={action}>
        ...
        <input id="deviceName" name="deviceName" type="text" placeholder="Bench 2" autoComplete="off" required maxLength={40} />
        <label htmlFor="staffLabel">Your name (optional)</label>
        <input id="staffLabel" name="staffLabel" type="text" placeholder="Dara" autoComplete="off" maxLength={40} />
